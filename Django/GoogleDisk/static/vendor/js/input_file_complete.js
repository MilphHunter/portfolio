...
function updateImageListAfterInput(img) {
    ...
    img.forEach(function (file) {
        ...
        closeButton.setAttribute('data-type', 'note_img');
...
function updateVideoList(video) {
    ...
    video.forEach(function (file) {
        ...
        closeButton.setAttribute('data-file', file);
        closeButton.setAttribute('data-type', 'note_video');
        closeButton.setAttribute('aria-label', 'Close');
...
function updateAudioList(audio) {
    ...
    audio.forEach(function (file) {
        ...
        audioImg.className = 'card-img-top'
        audioImg.src = file['note_audio_image'] ? file['note_audio_image'] : "/static/vendor/img/icon/music_img.png";
        ...
        closeButton.setAttribute('data-type', 'note_audio');
        closeButton.setAttribute('aria-label', 'Close');
        ...
        audioSource.src = file['note_audio'];
...
function updateOtherList(other) {
    ...
    other.forEach(function (file) {
        ...
        closeButton.setAttribute('data-type', 'note_other');
        closeButton.setAttribute('aria-label', 'Close');
        divClose.appendChild(closeButton);
...
$(document).on('click', '.btn-close', function () {
    ...
    $.ajax({
        ...
        data: {'fileToDelete': fileToDelete, 'fileType': fileType, 'noteId': noteId},
