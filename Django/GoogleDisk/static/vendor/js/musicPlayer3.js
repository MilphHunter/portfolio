...
function togglePlayPause(button) {
    ...
    if (music.paused) {
        ...
        pButton.src = "/static/vendor/content/img/pause-button.png";
    } else {
        music.pause();
        pButton.classList.remove('fa-pause');
        pButton.classList.add('fa-play');
        pButton.src = "/static/vendor/content/img/play-button.png";
    }
}
...
function updateInterface(music, playhead, pButton) {
    ...
    pButton.classList.remove('fa-pause');
    pButton.classList.add('fa-play');
    pButton.src = '/static/vendor/icon/img/play-button.png';
}
