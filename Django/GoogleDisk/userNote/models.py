...
class TemplateUserNoteContent(models.Model):
    ...
    note_audio = models.FileField(upload_to='files/audio/', default='', blank=True)
    note_audio_title = models.TextField(default='', blank=True)
    note_audio_author = models.TextField(default='', blank=True)
    note_audio_image = models.TextField(default='', blank=True)
