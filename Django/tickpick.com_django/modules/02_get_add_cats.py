...
add_cat = [
'https://www.tickpick.com/golf-tickets/',
    'https://www.tickpick.com/ncaa-basketball-tickets/',
    'https://www.tickpick.com/wwe-tickets/',
    'https://www.tickpick.com/wnba-tickets/',
    'https://www.tickpick.com/march-madness-tickets/',
    'https://www.tickpick.com/music-festival-tickets/',
    'https://www.tickpick.com/soccer-tickets/',
    'https://www.tickpick.com/mls-tickets/',
    'https://www.tickpick.com/laliga-tickets/',
    'https://www.tickpick.com/tennis-tickets/',
    'https://www.tickpick.com/horse-racing-tickets/',
    'https://www.tickpick.com/mixed-martial-arts-tickets/',
    'https://www.tickpick.com/ufc-tickets/',
    'https://www.tickpick.com/formula-1-tickets/',
    'https://www.tickpick.com/nascar-tickets/',
    'https://www.tickpick.com/theater-tickets/',
    'https://www.tickpick.com/ncaa-football-tickets/',
    'https://www.tickpick.com/comedy-tickets/',
...
def save(data):
    for cat in data:
        ...
        if created:
            print(f'[LOG] Event {cat[0]} created.')
        else:
            print(f'[LOG] Event {cat[0]} already exists.')

def parse_html(html):
    soup = BeautifulSoup(html, 'html.parser')
    main_tag = soup.find('div', class_='tpTabItemMain')
    a_tags = main_tag.find_all('a', class_='contentItem')
    data = [(a.text.strip(), 'https://www.tickpick.com' + a.get('href')) for a in a_tags]
    save(data)
